...
class TinyStoriesDataModule(L.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None):
        cache_path_train = os.path.join(config.cache_dir, "tinystories_train_dataset.json")
        cache_path_val = os.path.join(config.cache_dir, "tinystories_val_dataset.json")
